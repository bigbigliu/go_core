...
Base64captcha supports any unicode character and can easily be custoapped to support Math Chinese Korean Japanese Russian Arabic etc.
...
## 3. 🎨🎨🎨 Custoappation
You can custoappe your captcha display image by implementing [interface driver](interface_driver.go) 
