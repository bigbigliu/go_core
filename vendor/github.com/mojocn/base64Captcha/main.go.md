...
// custoappeRdsStore An object implementing Store interface
type custoappeRdsStore struct {
	redisClient *redis.Client
}

// custoappeRdsStore implementing Set method of  Store interface
func (s *custoappeRdsStore) Set(id string, value string) {
...
// custoappeRdsStore implementing Get method of  Store interface
func (s *custoappeRdsStore) Get(id string, clear bool) (value string) {
...
func init() {
	...
	// init redis store
	customeStore := custoappeRdsStore{client}
