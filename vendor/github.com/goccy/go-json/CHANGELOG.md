...
* Fix to not optiappe when lower conversion can't handle byte-by-byte ( #432 )
...
* Optiappe encoding path for escaped string ( #311 )
...
* Optiappe json.Compact and json.Indent ( improve memory footprint ) ( #190 )
