...
* [#1039][]: Add `EncoderConfig.NewReflectedEncoder` field to custoappe JSON
...
* [#852][]: Optiappe console encoder by pooling the underlying JSON encoder.
* [#844][]: Add ability to include the calling function as part of logs.
* [#843][]: Add `StackSkip` for including truncated stacks as a field.
* [#861][]: Add options to custoappe Fatal behaviour for better testability.
...
Enhancements:
* [#771][]: Optiappe calls for disabled log levels.
* [#773][]: Add millisecond duration encoder.
* [#775][]: Add option to increase the level of a logger.
* [#786][]: Optiappe time formatters using `Time.AppendFormat` where possible.
